...
public final class Strings {
	...
	/**
	 * Found this method a long time ago in Bukkit forums and I can't seem to find
	 * the original author. Please tell me if you know who made this ;)
	 */
	public static String rainbowlize(String string) {
		...
		for (int i = 0; i < string.length(); i++) {
			...
			newString += ChatColor.RESET.toString() + ChatColor.getByChar(colors.charAt(currColor)) + ""
					+ string.charAt(i);
		}
		return newString;
	}
